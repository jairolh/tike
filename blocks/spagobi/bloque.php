...
use spagobi\funcion\redireccion;
// ------------------
		...
		if (isset ( $_REQUEST ['botonCancelar'] ) && $_REQUEST ['botonCancelar'] == "true") {
			...
			if (! isset ( $_REQUEST ['action'] )) {
                                ...
                                $log=array('accion'=>"INGRESO",
                                          'id_registro'=>$_REQUEST['reporte'],
                                          'tipo_registro'=>"spagobi",
                                          'nombre_registro'=>$_REQUEST['reporte']."|".$_REQUEST['ruta'],
                                          'descripcion'=>"Ingreso a sistema spagobi Reporte ".$_REQUEST['nombrerep'],
                                         ); 
